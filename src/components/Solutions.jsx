...
<div className="section-header reveal">
          <span className="section-tag" style={{ fontSize: 'clamp(1.75rem, 3.5vw, 2.5rem)', fontWeight: 700, textTransform: 'none', letterSpacing: '-0.02em', marginBottom: '1rem', display: 'block' }}>OUR SOLUTIONS</span>
        </div>
